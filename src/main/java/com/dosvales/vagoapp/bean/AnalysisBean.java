...
public class AnalysisBean implements Serializable {
	...
	public void openNew() {
		...
		analysis.setTypeAnalysis(TypeAnalysis.PRELIMINARY);
	}
	...
	public boolean isValidToDelete(Analysis a) {
		if (a.getTypeAnalysis() == TypeAnalysis.PRELIMINARY) {
			return a.getProduction().getProductionStatus() == ProductionStatus.PRELIMINARYANALYSIS;
		} else {
	...
	public void refreshTable() {
		if (status.equals("ALL")) {
			...
			analyzes = analysisService.findAllPreliminaryAnalysis();
		} else {
	...
	public List<Production> getProductions() {
		if (analysis.getTypeAnalysis() == TypeAnalysis.PRELIMINARY) {
			productions = productionService.findAllWithoutPreliminaryAnalysis();
